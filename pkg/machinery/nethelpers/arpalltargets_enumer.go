// Code generated by "enumer -type=ARPAllTargets,ARPValidate,AddressFlag,AddressSortAlgorithm,ADSelect,ADLACPActive,AutoHostnameKind,BondMode,BondXmitHashPolicy,ClientIdentifier,ConntrackState,DefaultAction,Duplex,Family,LACPRate,LinkFlag,LinkType,MatchOperator,NfTablesChainHook,NfTablesChainPriority,NfTablesVerdict,OperationalState,Port,PrimaryReselect,Protocol,RouteFlag,RouteProtocol,RouteType,RoutingTable,Scope,Status,VLANProtocol,WOLMode,FailOverMAC -linecomment -text"; DO NOT EDIT.
...
// MarshalText implements the encoding.TextMarshaler interface for FailOverMAC
func (i FailOverMAC) MarshalText() ([]byte, error) {
	return []byte(i.String()), nil
}

// UnmarshalText implements the encoding.TextUnmarshaler interface for FailOverMAC
func (i *FailOverMAC) UnmarshalText(text []byte) error {
	var err error
	*i, err = FailOverMACString(string(text))
	return err
}
